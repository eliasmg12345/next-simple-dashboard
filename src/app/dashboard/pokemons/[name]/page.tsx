...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  try {
    ...
    return {
      title: `#${id} - ${name}`,
      description: `Pagina del pok: ${name}`
    }

  } catch (error) {
    return {
      title: `Pagina del pokemoon`,
      description: `Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem quae dolorum quisquam, quam sapiente magnam architecto cupiditate ex, suscipit enim laborum tempora nesciunt earum esse reiciendis expedita! Aliquam, laboriosam eos?`
    }
